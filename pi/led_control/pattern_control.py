...
rgb_flash_red = [[[100, 0, 0], 50], [[100, 0, 0], 1], [[0, 0, 100], 10], [[0, 0, 100], 1], [[0, 100, 0], 10], [[0, 100, 0], 1], [[100, 0, 0], 10], [[100, 0, 0], 1]]
rgb_flash_blue = [[[0, 0, 100], 50], [[0, 0, 100], 1], [[0, 100, 0], 10], [[0, 100, 0], 1], [[100, 0, 0], 10], [[100, 0, 0], 1], [[0, 0, 100], 10], [[0, 0, 100], 1]]
rgb_flash_green = [[[0, 100, 0], 50], [[0, 100, 0], 1], [[100, 0, 0], 10], [[100, 0, 0], 1], [[0, 0, 100], 10], [[0, 0, 100], 1], [[0, 100, 0], 10], [[0, 100, 0], 1]]

pattern = rgb_flash_red + rgb_flash_blue + rgb_flash_green
